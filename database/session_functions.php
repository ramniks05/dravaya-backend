...
const USER_SESSION_TTL_MINUTES = 720; // 12 hours

/**
 * Ensure user_sessions table exists (idempotent)
 */
...
function createUserSession(string $userId, string $token, ?int $ttlMinutes = null): array
{
    ...
    $expiresAt = getIstTimestamp("+{$ttlMinutes} minutes");
